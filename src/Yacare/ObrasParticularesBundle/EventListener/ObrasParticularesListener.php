...
class ObrasParticularesListener implements EventSubscriber
{
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        if (is_a($entity, 'Yacare\ObrasParticularesBundle\Entity\ActaObra')) {
            // Capturo los eventos si la entidad es un ActaObra.
            ...
            $Helper->LifecycleEvent($args);
        } elseif (is_a($entity, 'Yacare\ObrasParticularesBundle\Entity\Cat')) {
            // Capturo los eventos si la entidad es un CAT-Ed
            $Helper = new \Yacare\ObrasParticularesBundle\Helper\CatHelper();
            $Helper->LifecycleEvent($args);
